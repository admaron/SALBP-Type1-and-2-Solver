...
! function (t, e) {
    ...
    function Ve(t, e, i, o, a, r = {}) {
        ...
        for (t.save(), t.font = a.string, function (t, e) {
            ...
            }(t, r), c = 0; c < l.length; ++c) d = l[c], r.backdrop && Ne(t, r.backdrop), h && (r.strokeColor && (t.strokeStyle = r.strokeColor), s(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, i, o, r.maxWidth)), t.fillText(d, i, o, r.maxWidth), Be(t, i, o, d, r), o += a.lineHeight;
        t.restore()
    }
    ...
    function He(t, e = [""], i = t, s, n = (() => t[0])) {
        ...
        return new Proxy(o, {
            ...
            get: (i, s) => Xe(i, s, (() => function (t, e, i, s) {
                let n;
                for (const o of e)
                    if (n = Qe(Ye(o, t), i), k(n)) return Ue(t, n) ? Ze(i, s, t, n) : n
            }(s, e, t, i))),
    ...
    function Ze(t, e, i, s) {
        ...
        return null !== c && ((!k(r) || r === i || (c = Je(h, l, r, c, s), null !== c)) && He(Array.from(h), [""], a, r, (() => function (t, e, i) {
    ...
    function ai(t, e = "x") {
        ...
        function (t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c) l = h, h = si(t, c + 1), l && h && (V(e[c], 0, ii) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o),
        function (t, e, i = "x") {
            const s = ni(i),
                n = t.length;
    ...
    function Li(t, e, i) {
        ...
        const y = () => x || l(n, b, p) && 0 !== r(n, b),
            v = () => !x || 0 === r(o, p) || l(o, b, p);
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ti({
            start: _,
            end: t,
            loop: u,
            count: a,
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    ...
                    e = zi(s.setContext(Pi(n, {
                        ...
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Fi(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (t.$chartjs = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", ls(n)) {
                    const e = Se(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (ls(s))
    ...
    class qs extends Bs {
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = i = Object.assign({
                ...
                top: 0,
                bottom: 0
            }, i), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + i.left + i.right : this.height + i.top + i.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = Si(this, n, s), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
        ...
        fit() {
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Ys(n) + o) : (t.height = this.maxHeight, t.width = Ys(n) + o), i.display && this.ticks.length) {
                    const {
                        first: e,
                        last: s,
                        widest: n,
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                ...
                let i = this.ticks;
                e < i.length && (i = js(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length)
            }
            return t
        }
        _computeLabelSizes(t, e) {
            ...
            let l, h, c, d, f, g, p, m, b, x, _, y = 0,
                v = 0;
            for (l = 0; l < e; ++l) {
                if (d = t[l].label, f = this._resolveTickFontOptions(l), i.font = g = f.string, p = o[g] = o[g] || {
                        data: {},
                        gc: []
                    }, m = f.lineHeight, b = x = 0, s(d) || n(d)) {
                    if (n(d))
                        for (h = 0, c = d.length; h < c; ++h) _ = d[h], s(_) || n(_) || (b = De(i, p.data, p.gc, b, _), x += m)
        ...
        _computeGridLineItems(t) {
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                y = $s(this, _, h), void 0 !== y && (v = Oe(i, y, o), c ? M = k = P = C = v : w = S = D = O = v, f.push({
                    tx1: M,
                    ty1: w,
                    tx2: k,
                    ty2: S,
    ...
    class Gs {
        constructor() {
            this.controllers = new Ks(Vs, "datasets", !0), this.elements = new Ks(Bs, "elements"), this.plugins = new Ks(Object, "plugins"), this.scales = new Ks(qs, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    function sn(t, e) {
        ...
        var i;
        if (t = e.axis || ("top" === (i = e.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && sn(t[0].toLowerCase(), e)) return t;
    ...
    class cn {
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => hn(r, t, e)))), e.forEach((t => hn(r, s, t))), e.forEach((t => hn(r, re[n] || {}, t))), e.forEach((t => hn(r, ue, t))), e.forEach((t => hn(r, le, t)))
            }));
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), rn.has(e) && o.set(e, l), l
        }
        chartOptionScopes() {
            const {
                options: t,
    ...
    const un = t => o(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || S(t[i])), !1);
    ...
    const _n = {},
        yn = t => {
            const e = xn(t);
            return Object.values(_n).filter((t => t.canvas === e)).pop()
        };
    ...
    class Mn {
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                const n = e.options,
                    ...
                    a = sn(o, n),
                    r = l(n.type, e.dtype);
                void 0 !== n.position && gn(n.position, a) === gn(e.dposition) || (n.position = e.dposition), s[o] = !0;
                let h = null;
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || en(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
                else {
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (xt.has(this) ? this.attached && !xt.running(this) && xt.start(this) : (this.draw(), mn({
                chart: this
            })))
        }
        draw() {
    ...
    function On(t, e, i, s) {
        const n = t.iScale,
            ...
            l = [];
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(Cn(u, d, o, h));
        return l
    }
    ...
    function Tn(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Ln(c, a, r, l)] = !0, n = h)), o[Ln(n, a, r, l)] = !0, t.borderSkipped = o
    }

    function Ln(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = En(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = En(t, e, i), t
    }
    ...
    var Fn = Object.freeze({
        ...
        BarController: class extends Vs {
            ...
            parseObjectData(t, e, i, s) {
                ...
                let d, u, f, g;
                for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(M(g, l), d), c.push(Cn(M(g, h), f, o, d));
                return c
            }
            updateRangeFromParsed(t, e, i, s) {
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta,
                    ...
                    n = this.getParsed(t),
                    o = n._custom,
                    a = An(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
                return {
                ...
                for (let f = e; f < e + i; f++) {
                    const e = this.getParsed(f),
                        ...
                        m = {
                            horizontal: h,
                            base: i.base,
                            enableBorderRadius: !p || An(e._custom) || a === p._top || a === p._bottom,
                            x: h ? i.head : g.center,
                            y: h ? g.center : i.head,
            ...
            _calculateBarValuePixels(t) {
                ...
                } = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = An(h);
                let d, u, f = l[e.axis],
                    g = 0,
    ...
    function Wn(t, e, i, s, n) {
        ...
        }(t, e, u), o || (Nn(t, e, i, s, u, n), t.stroke())
    }
    ...
    function Yn(t, e, i, s) {
        const {
            ...
            return t.stepped ? ze : t.tension || "monotone" === t.cubicInterpolationMode ? Fe : jn
        }(o);
        let d, u, f, {
            move: g = !0,
            reverse: p
    ...
    function to(t) {
        const e = Jn(t),
            ...
            a = function (t, e, i) {
                ...
                } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, a = vi(n), r = Math.min(e, i), l = t.borderSkipped, h = s || o(n);
                return {
        ...
        ArcElement: class extends Bs {
            ...
            draw(t) {
                ...
                t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                    ...
                    }(t, this, r, n, o), Wn(t, this, r, n, o), t.restore()
            }
        },
        LineElement: Gn,
        ...
        BarElement: class extends Bs {
            ...
            draw(t) {
                const {
                    ...
                    inner: n,
                    outer: o
                } = to(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? We : io;
                var r;
    ...
    class lo extends qs {
        ...
        buildTicks() {
            ...
            const n = function (t, e) {
                ...
                for (b && (u && M !== a ? (i.push({
                        value: a
                    }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, ro(a, y, t)) && D++) : M < a && D++); D < k; ++D) i.push({
                    value: Math.round((M + D * S) * v) / v
                });
                return x && u && w !== r ? i.length && V(i[i.length - 1].value, r, ro(r, y, t)) ? i[i.length - 1].value = r : i.push({
                    value: r
                }) : x && w !== r || i.push({
                    value: w
                }), i
    ...
    class So extends lo {
        ...
        generateTickLabels(t) {
            lo.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
            ...
            if (e.pointLabels.display && function (t, e) {
                    ...
                    for (let o = e - 1; o >= 0; o--) {
                        ...
                        if (!s(g)) {
                            ...
                            const n = c - s.left,
                                ...
                                a = u - c + s.width,
                                r = f - d + s.height;
                            Object.values(t).some((t => 0 !== t)) ? (i.beginPath(), We(i, {
                                x: n,
                                y: o,
                                w: a,
                                h: r,
                    ...
                    if (0 !== e) {
                        ...
                        ! function (t, e, i, s, n) {
                            ...
                            !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), ko(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                        }(this, s, l, a, r)
                    }
                })), i.display) {
    ...
    class Eo extends qs {
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = nt(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? Ao(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
            ...
            }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), Lo(this, o, this._majorUnit)
        }
        afterAutoSkip() {
        ...
        _generate() {
            ...
            return d !== i && "ticks" !== s.bounds && 1 !== u || To(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {
    ...
    var Io = Object.freeze({
        ...
        CategoryScale: class extends qs {
            ...
            parse(t, e) {
                ...
                return ((t, e) => null === t ? null : J(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : oo(i, t, l(e, t), this._addedLabels), i.length - 1)
            }
            determineDataLimits() {
                const {
                    minDefined: t,
    ...
    const zo = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
    ...
    function No(t) {
        ...
        return (i, s) => {
            ...
            n instanceof In ? e = function (t, e) {
                return t.backgroundColor = t.data.map((() => Vo(e++))), e
            }(i, e) : n instanceof zn ? e = function (t, e) {
    ...
    var Ho = {
        ...
        beforeLayout(t, e, i) {
            ...
            if (!i.forceOverride && (Wo(s) || (a = n) && (a.borderColor || a.backgroundColor) || o && Wo(o))) return;
            var a;
            const r = No(t);
            s.forEach(r)
        }
    ...
    function sa(t, e, i) {
        ...
        s && n.points.length && (Re(t, i), function (t, e) {
            ...
            t.save(), "x" === l && o !== n && (na(t, s, a.top), oa(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), na(t, s, a.bottom));
            oa(t, {
                line: i,
                target: s,
                color: o,
            ...
            for (const t of s) {
                ...
                for (const e of h) {
                    ...
                    for (const t of r) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: qo(l, s, "start", Math.max)
                        },
                        end: {
                            [i]: qo(l, s, "end", Math.min)
                        }
                    })
                }
            }
    ...
    var la = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a) l = n[a], l && !1 !== l.fill && (l.fill = Zo(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const i = n[e].$filler;
                i && (i.line.updateControlPoints(o, i.axis), s && i.fill && sa(t.ctx, i, o))
            }
        },
    ...
    class ca extends Bs {
        ...
        _draw() {
            const {
                ...
                align: n,
                labels: o
            } = t, a = ue.color, r = Di(t.rtl, this.left, this.width), h = wi(o.font), {
                padding: c
            } = o, d = h.size, u = d / 2;
            let f;
            ...
            const {
                ...
                boxHeight: p,
                itemHeight: m
            } = ha(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            f = b ? {
                ...
                if (function (t, e, i) {
                        ...
                        if (s.fillStyle = l(i.fillStyle, a), s.lineCap = l(i.lineCap, "butt"), s.lineDashOffset = l(i.lineDashOffset, 0), s.lineJoin = l(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = l(i.strokeStyle, a), s.setLineDash(l(i.lineDash, [])), o.usePointStyle) {
                            ...
                            const o = e + Math.max((d - p) / 2, 0),
                                a = r.leftForLtr(t, g),
                                l = vi(i.borderRadius);
                            s.beginPath(), Object.values(l).some((t => 0 !== t)) ? We(s, {
                                x: a,
                                y: o,
                                w: g,
                                h: p,
    ...
    function wa(t, e, i) {
        ...
        return {
            xAlign: i.xAlign || e.xAlign || Ma(t, e, i, s),
            yAlign: s
        }
    }
    ...
    class Aa extends Bs {
        ...
        getTitle(t, e) {
            const {
                callbacks: i
            } = e, s = Oa(i, "beforeTitle", this, t), n = Oa(i, "title", this, t), o = Oa(i, "afterTitle", this, t);
            let a = [];
        ...
        getBody(t, e) {
            ...
            return u(t, (t => {
                const e = {
                    ...
                    n = Da(i, t);
                xa(e.before, _a(Oa(n, "beforeLabel", this, t))), xa(e.lines, Oa(n, "label", this, t)), xa(e.after, _a(Oa(n, "afterLabel", this, t))), s.push(e)
            })), s
        }
        getAfterBody(t, e) {
        ...
        getFooter(t, e) {
            const {
                callbacks: i
            } = e, s = Oa(i, "beforeFooter", this, t), n = Oa(i, "footer", this, t), o = Oa(i, "afterFooter", this, t);
            let a = [];
            return a = xa(a, _a(s)), a = xa(a, _a(n)), a = xa(a, _a(o)), a
        }
        _createItems(t) {
            ...
            return t.filter && (l = l.filter(((e, s, n) => t.filter(e, s, n, i)))), t.itemSort && (l = l.sort(((e, s) => t.itemSort(e, s, i)))), u(l, (e => {
                ...
                s.push(Oa(i, "labelColor", this, e)), n.push(Oa(i, "labelPointStyle", this, e)), o.push(Oa(i, "labelTextColor", this, e))
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Sa(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = wi(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                ...
                const e = s.leftForLtr(f, h - c),
                    ...
                    r = vi(a.borderRadius);
                Object.values(r).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, We(t, {
                    x: e,
                    y: p,
                    w: h,
                    h: l,
                    ...
                    h: l - 2,
                    radius: r
                }), t.fill()) : (t.fillStyle = n.multiKeyBackground, t.fillRect(e, p, h, l), t.strokeRect(e, p, h, l), t.fillStyle = a.backgroundColor, t.fillRect(i, p + 1, h - 2, l - 2))
            }
        ...
        drawBody(t, e, i) {
            ...
            const g = Di(i.rtl, this.x, this.width),
                ...
                m = g.textAlign(o);
            let b, x, _, y, v, M, w;
            for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Sa(this, m, i), e.fillStyle = i.bodyColor, u(this.beforeBody, p), f = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0, y = 0, M = s.length; y < M; ++y) {
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Sa(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = wi(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = ba[n.position].call(this, t, e);
